    ...
    <div className="min-h-screen bg-[#0f172a] text-white font-sans flex flex-col">
      ...
      <nav className="flex justify-between items-center p-6 max-w-7xl mx-auto w-full">
        ...
        <div className="flex items-center gap-6">
          {/* CHANGED: "GHL App Store" -> "App Marketplace" */}
      ...
      <main className="flex-grow flex items-center justify-center">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            {/* CHANGED: "Built for GoHighLevel" -> "Seamless CRM Integration" */}
            ...
            {/* CHANGED: "HighLevel contacts" -> "CRM contacts" */}
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              ...
              {/* CHANGED: "View on GHL App Store" -> "View on Marketplace" */}
          ...
          <div className="flex justify-center relative">
             <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-[#2b998e]/20 blur-[100px] rounded-full -z-10"></div>
             <img 
               src="/robot-mascot.png" 
               alt="App Mascot" 
               className="w-full max-w-sm drop-shadow-2xl animate-pulse"
